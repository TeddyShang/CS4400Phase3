...
<table id="confirmedProperties" class="table table-striped table-bordered" style="width:100%">
    <thead>
    <tr>
        <th>Name</th>
        <th>Street</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#confirmedProperties tfoot th').each( function () {
            var title = $(this).text();
            $(this).html( '<input type="text" placeholder="Search '+title+'" />' );
        } );

        // DataTable
        var table = $('#confirmedProperties').DataTable();

        //What is clicked
        $('#confirmedProperties tbody').on( 'click', 'tr', function () {
