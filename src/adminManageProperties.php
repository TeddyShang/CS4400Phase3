...
<div class ="text-center">
    ...
    <form class = "needs-validation" novalidate action="adminUpdateProperty.php" method="post">
        ...
        <button class="btn btn-primary btn-lg"  value='<?php echo$id;?>'name ="submit" type="submit">Save Changes (Confirm Property)</button>
    </form>
    <br>
    <button onclick= "goBack()" class="btn btn-primary btn-lg" role="button">Back (Don't Save or Confirm)</button>
